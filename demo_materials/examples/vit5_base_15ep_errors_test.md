# vit5_base_15ep — error examples (test)
...
- SRC : `Tôi sẽ để bạn lo phần còn lại .`
  REF : `Tôi bạn lo phần còn .`
  HYP : `Tôi để bạn lo phần còn .`
...
- SRC : `Để xem kết quả thế nào trong một lúc đã .`
  REF : `xem kết quả trong một lúc .`
  HYP : `xem kết quả thế nào trong một lúc .`

## deletion_reorder  (13 mismatched)
